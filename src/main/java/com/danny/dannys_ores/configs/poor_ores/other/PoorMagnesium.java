...
public class PoorMagnesium {
    ...
    static {
        ...
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Red Sandstone Poor Magnesium Ore").push("red_sandstone_poor_magnesium_ore");
        BUILDER.comment(CommentHandler.getGenerationComment()).push(PathHandler.getGenerationPath());
        ...
        veinsPerChunkBedrockPoorMagnesiumOre = BUILDER.comment(CommentHandler.getVeinsPerChunkComment()).defineInRange(PathHandler.getVeinsPerChunkPath(), 4, 0, 65536);
        ...
        maxHeightBedrockPoorMagnesiumOre = BUILDER.comment(CommentHandler.getMaxHeightComment()).defineInRange(PathHandler.getMaxHeightPath(), 128, 0, 256);
