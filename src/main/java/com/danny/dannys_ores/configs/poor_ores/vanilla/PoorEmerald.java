...
public class PoorEmerald {
    ...
    static {
        ...
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Red Sandstone Poor Emerald Ore").push("red__sandstone_poor_emerald_ore");
        BUILDER.comment(CommentHandler.getGenerationComment()).push(PathHandler.getGenerationPath());
        ...
        veinsPerChunkBedrockPoorEmeraldOre = BUILDER.comment(CommentHandler.getVeinsPerChunkComment()).defineInRange(PathHandler.getVeinsPerChunkPath(), 1, 0, 65536);
        ...
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Lime Stone Poor Emerald Ore (Quark)").push("quark_limestone_emerald_ore");
        BUILDER.comment(CommentHandler.getGenerationComment()).push(PathHandler.getGenerationPath());
