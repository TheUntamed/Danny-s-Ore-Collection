...
public class PoorUranium {
    ...
    static {
        ...
        disablePoorPoisonEffectUraniumOres = BUILDER.comment("If true, uranium ores will not poison players while in thair inventory/hand.").define("disablePoisonEffect", false);
