...
public class PoorUranium {
    ...
    static {
        ...
        disablePoorPoisonEffectUraniumOres = BUILDER.comment("If true, poor uranium ores will not poison players while in their inventory/hand.").define("disablePoisonEffect", false);
        ...
        veinsPerChunkBedrockPoorUraniumOre = BUILDER.comment(CommentHandler.getVeinsPerChunkComment()).defineInRange(PathHandler.getVeinsPerChunkPath(), 4, 0, 65536);
