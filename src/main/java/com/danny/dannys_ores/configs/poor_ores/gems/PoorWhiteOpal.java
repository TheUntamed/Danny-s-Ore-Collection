...
public class PoorWhiteOpal {
    ...
    static {
        ...
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Red Sandstone Poor WhiteOpal Ore").push("red__sandstone_poor_white_opal_ore");
        BUILDER.comment(CommentHandler.getGenerationComment()).push(PathHandler.getGenerationPath());
        ...
        veinsPerChunkBedrockPoorWhiteOpalOre = BUILDER.comment(CommentHandler.getVeinsPerChunkComment()).defineInRange(PathHandler.getVeinsPerChunkPath(), 1, 0, 65536);
        ...
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Lime Stone Poor WhiteOpal Ore (Quark)").push("quark_limestone_white_opal_ore");
        BUILDER.comment(CommentHandler.getGenerationComment()).push(PathHandler.getGenerationPath());
