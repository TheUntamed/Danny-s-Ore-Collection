...
public class PoorBlackQuartz {
    ...
    static {
        ...
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Red Sandstone Poor Black Quartz Ore").push("red__sandstone_poor_black_quartz_ore");
        BUILDER.comment(CommentHandler.getGenerationComment()).push(PathHandler.getGenerationPath());
        ...
        veinsPerChunkBedrockPoorBlackQuartzOre = BUILDER.comment(CommentHandler.getVeinsPerChunkComment()).defineInRange(PathHandler.getVeinsPerChunkPath(), 1, 0, 65536);
        ...
        maxHeightBedrockPoorBlackQuartzOre = BUILDER.comment(CommentHandler.getMaxHeightComment()).defineInRange(PathHandler.getMaxHeightPath(), 256, 0, 256);
        ...
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Lime Stone Poor Black Quartz Ore (Quark)").push("quark_limestone_black_quartz_ore");
        BUILDER.comment(CommentHandler.getGenerationComment()).push(PathHandler.getGenerationPath());
