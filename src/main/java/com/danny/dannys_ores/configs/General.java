...
public class General {
    ...
    static {
        ...
        BUILDER.comment("Disable all Ores of a certain stone variant (only affects ores of this mod). (Require game restart.)").push("stone_variants");
        ...
        BUILDER.pop();
        BUILDER.comment("Manipulate vanilla and other mods ore generation. (Require game restart.)").push("vanilla_and_other_mods");
