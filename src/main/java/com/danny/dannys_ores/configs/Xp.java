...
public class Xp {
    ...
    static {
        ...
        veinSizeEndStoneXpOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEndStoneXpOre", 1, 0, 65536);
        veinsPerChunkEndStoneXpOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEndStoneXpOre", 11, 0, 65536);
        ...
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enableBlueIceXpOre = BUILDER.comment("If false, this ore variant will not generate.").define("enableBlueIceXpOre", true);
        veinSizeBlueIceXpOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeBlueIceXpOre", 1, 0, 65536);
        veinsPerChunkBlueIceXpOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkBlueIceXpOre", 11, 0, 65536);
        minHeightBlueIceXpOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightBlueIceXpOre", 40, 0, 256);
        maxHeightBlueIceXpOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightBlueIceXpOre", 128, 0, 256);
        isTempWhitelistBlueIceXpOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistBlueIceXpOre", false);
        temperatureBlacklistBlueIceXpOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistBlueIceXpOre", new ArrayList<String>());
        isBiomeWhitelistBlueIceXpOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistBlueIceXpOre", false);
        ...
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enablePackedIceXpOre = BUILDER.comment("If false, this ore variant will not generate.").define("enablePackedIceXpOre", true);
        veinSizePackedIceXpOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizePackedIceXpOre", 1, 0, 65536);
        veinsPerChunkPackedIceXpOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkPackedIceXpOre", 11, 0, 65536);
        minHeightPackedIceXpOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightPackedIceXpOre", 40, 0, 256);
        maxHeightPackedIceXpOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightPackedIceXpOre", 128, 0, 256);
        isTempWhitelistPackedIceXpOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistPackedIceXpOre", false);
        temperatureBlacklistPackedIceXpOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistPackedIceXpOre", new ArrayList<String>());
        isBiomeWhitelistPackedIceXpOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistPackedIceXpOre", false);
        ...
        minHeightQuarkBasaltXpOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkBasaltXpOre", 10, 0, 256);
        maxHeightQuarkBasaltXpOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkBasaltXpOre", 96, 0, 256);
