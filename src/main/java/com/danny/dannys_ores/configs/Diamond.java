...
public class Diamond {
    ...
    public static ForgeConfigSpec.DoubleValue resistanceBlueIceDiamondOre;
    ...
    public static ForgeConfigSpec.DoubleValue resistancePackedIceDiamondOre;
    ...
    static {
        ...
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enableBlueIceDiamondOre = BUILDER.comment("If false, this ore variant will not generate.").define("enableBlueIceDiamondOre", true);
        veinSizeBlueIceDiamondOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeBlueIceDiamondOre", 8, 0, 65536);
        veinsPerChunkBlueIceDiamondOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkBlueIceDiamondOre", 1, 0, 65536);
        minHeightBlueIceDiamondOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightBlueIceDiamondOre", 0, 0, 256);
        maxHeightBlueIceDiamondOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightBlueIceDiamondOre", 128, 0, 256);
        isTempWhitelistBlueIceDiamondOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistBlueIceDiamondOre", false);
        temperatureBlacklistBlueIceDiamondOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistBlueIceDiamondOre", new ArrayList<String>());
        isBiomeWhitelistBlueIceDiamondOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistBlueIceDiamondOre", false);
        biomeBlacklistBlueIceDiamondOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistBlueIceDiamondOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Packed Ice Diamond Ore").push("packed_ice_diamond_ore");
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enablePackedIceDiamondOre = BUILDER.comment("If false, this ore variant will not generate.").define("enablePackedIceDiamondOre", true);
        veinSizePackedIceDiamondOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizePackedIceDiamondOre", 8, 0, 65536);
        veinsPerChunkPackedIceDiamondOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkPackedIceDiamondOre", 1, 0, 65536);
        minHeightPackedIceDiamondOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightPackedIceDiamondOre", 0, 0, 256);
        maxHeightPackedIceDiamondOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightPackedIceDiamondOre", 128, 0, 256);
        isTempWhitelistPackedIceDiamondOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistPackedIceDiamondOre", false);
        temperatureBlacklistPackedIceDiamondOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistPackedIceDiamondOre", new ArrayList<String>());
        isBiomeWhitelistPackedIceDiamondOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistPackedIceDiamondOre", false);
        biomeBlacklistPackedIceDiamondOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistPackedIceDiamondOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Bedrock Diamond Ore").push("bedrock_diamond_ore");
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enableBedrockDiamondOre = BUILDER.comment("If false, this ore variant will not generate.").define("enableBedrockDiamondOre", true);
        veinSizeBedrockDiamondOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeBedrockDiamondOre", 1, 0, 65536);
        veinsPerChunkBedrockDiamondOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkBedrockDiamondOre", 1, 0, 65536);
        minHeightBedrockDiamondOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightBedrockDiamondOre", 0, 0, 256);
        maxHeightBedrockDiamondOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightBedrockDiamondOre", 256, 0, 256);
        isTempWhitelistBedrockDiamondOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistBedrockDiamondOre", false);
        temperatureBlacklistBedrockDiamondOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistBedrockDiamondOre", new ArrayList<String>());
        isBiomeWhitelistBedrockDiamondOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistBedrockDiamondOre", false);
        biomeBlacklistBedrockDiamondOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistBedrockDiamondOre", new ArrayList<String>());
        BUILDER.pop();
        ...
        veinSizeHardenedStoneDiamondOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeHardenedStoneDiamondOre", 8, 0, 65536);
        veinsPerChunkHardenedStoneDiamondOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkHardenedStoneDiamondOre", 1, 0, 65536);
        minHeightHardenedStoneDiamondOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightHardenedStoneDiamondOre", 0, 0, 256);
        maxHeightHardenedStoneDiamondOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightHardenedStoneDiamondOre", 16, 0, 256);
