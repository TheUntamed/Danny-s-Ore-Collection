...
public class Redstone {
    ...
    static {
        ...
        veinsPerChunkNetherrackRedstoneOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkNetherrackRedstoneOre", 4, 0, 65536);
        ...
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enableBlueIceRedstoneOre = BUILDER.comment("If false, this ore variant will not generate.").define("enableBlueIceRedstoneOre", true);
        veinSizeBlueIceRedstoneOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeBlueIceRedstoneOre", 8, 0, 65536);
        veinsPerChunkBlueIceRedstoneOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkBlueIceRedstoneOre", 4, 0, 65536);
        minHeightBlueIceRedstoneOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightBlueIceRedstoneOre", 0, 0, 256);
        maxHeightBlueIceRedstoneOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightBlueIceRedstoneOre", 128, 0, 256);
        isTempWhitelistBlueIceRedstoneOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistBlueIceRedstoneOre", false);
        temperatureBlacklistBlueIceRedstoneOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistBlueIceRedstoneOre", new ArrayList<String>());
        isBiomeWhitelistBlueIceRedstoneOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistBlueIceRedstoneOre", false);
        biomeBlacklistBlueIceRedstoneOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistBlueIceRedstoneOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Packed Ice Redstone Ore").push("packed_ice_redstone_ore");
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enablePackedIceRedstoneOre = BUILDER.comment("If false, this ore variant will not generate.").define("enablePackedIceRedstoneOre", true);
        veinSizePackedIceRedstoneOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizePackedIceRedstoneOre", 8, 0, 65536);
        veinsPerChunkPackedIceRedstoneOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkPackedIceRedstoneOre", 4, 0, 65536);
        minHeightPackedIceRedstoneOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightPackedIceRedstoneOre", 0, 0, 256);
        maxHeightPackedIceRedstoneOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightPackedIceRedstoneOre", 128, 0, 256);
        isTempWhitelistPackedIceRedstoneOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistPackedIceRedstoneOre", false);
        temperatureBlacklistPackedIceRedstoneOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistPackedIceRedstoneOre", new ArrayList<String>());
        isBiomeWhitelistPackedIceRedstoneOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistPackedIceRedstoneOre", false);
        biomeBlacklistPackedIceRedstoneOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistPackedIceRedstoneOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Bedrock Redstone Ore").push("bedrock_redstone_ore");
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enableBedrockRedstoneOre = BUILDER.comment("If false, this ore variant will not generate.").define("enableBedrockRedstoneOre", true);
        veinSizeBedrockRedstoneOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeBedrockRedstoneOre", 1, 0, 65536);
        veinsPerChunkBedrockRedstoneOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkBedrockRedstoneOre", 1, 0, 65536);
        minHeightBedrockRedstoneOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightBedrockRedstoneOre", 0, 0, 256);
        maxHeightBedrockRedstoneOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightBedrockRedstoneOre", 256, 0, 256);
        isTempWhitelistBedrockRedstoneOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistBedrockRedstoneOre", false);
        temperatureBlacklistBedrockRedstoneOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistBedrockRedstoneOre", new ArrayList<String>());
        isBiomeWhitelistBedrockRedstoneOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistBedrockRedstoneOre", false);
        biomeBlacklistBedrockRedstoneOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistBedrockRedstoneOre", new ArrayList<String>());
        BUILDER.pop();
        ...
        veinsPerChunkQuarkBasaltRedstoneOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkBasaltRedstoneOre", 4, 0, 65536);
        ...
        veinSizeHardenedStoneRedstoneOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeHardenedStoneRedstoneOre", 8, 0, 65536);
        veinsPerChunkHardenedStoneRedstoneOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkHardenedStoneRedstoneOre", 8, 0, 65536);
        minHeightHardenedStoneRedstoneOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightHardenedStoneRedstoneOre", 0, 0, 256);
        maxHeightHardenedStoneRedstoneOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightHardenedStoneRedstoneOre", 16, 0, 256);
