...
public class Lead {
    ...
    static {
        ...
        veinSizeStoneLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeStoneLeadOre", 4, 0, 65536);
        veinsPerChunkStoneLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkStoneLeadOre", 4, 0, 65536);
        minHeightStoneLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightStoneLeadOre", 0, 0, 256);
        maxHeightStoneLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightStoneLeadOre", 40, 0, 256);
        ...
        biomeBlacklistStoneLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistStoneLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeAndesiteLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeAndesiteLeadOre", 4, 0, 65536);
        veinsPerChunkAndesiteLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkAndesiteLeadOre", 4, 0, 65536);
        minHeightAndesiteLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightAndesiteLeadOre", 0, 0, 256);
        maxHeightAndesiteLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightAndesiteLeadOre", 40, 0, 256);
        ...
        biomeBlacklistAndesiteLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistAndesiteLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeDioriteLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeDioriteLeadOre", 4, 0, 65536);
        veinsPerChunkDioriteLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkDioriteLeadOre", 4, 0, 65536);
        minHeightDioriteLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightDioriteLeadOre", 0, 0, 256);
        maxHeightDioriteLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightDioriteLeadOre", 40, 0, 256);
        ...
        biomeBlacklistDioriteLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistDioriteLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeGraniteLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeGraniteLeadOre", 4, 0, 65536);
        veinsPerChunkGraniteLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkGraniteLeadOre", 4, 0, 65536);
        minHeightGraniteLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightGraniteLeadOre", 0, 0, 256);
        maxHeightGraniteLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightGraniteLeadOre", 40, 0, 256);
        ...
        biomeBlacklistGraniteLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistGraniteLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinsPerChunkNetherrackLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkNetherrackLeadOre", 4, 0, 65536);
        ...
        biomeBlacklistNetherrackLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistNetherrackLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinsPerChunkEndStoneLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEndStoneLeadOre", 4, 0, 65536);
        ...
        biomeBlacklistEndStoneLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistEndStoneLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeSandLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeSandLeadOre", 4, 0, 65536);
        veinsPerChunkSandLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkSandLeadOre", 4, 0, 65536);
        minHeightSandLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightSandLeadOre", 0, 0, 256);
        ...
        biomeBlacklistSandLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistSandLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeRedSandLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeRedSandLeadOre", 4, 0, 65536);
        veinsPerChunkRedSandLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkRedSandLeadOre", 4, 0, 65536);
        minHeightRedSandLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightRedSandLeadOre", 0, 0, 256);
        ...
        biomeBlacklistRedSandLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistRedSandLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeGravelLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeGravelLeadOre", 4, 0, 65536);
        veinsPerChunkGravelLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkGravelLeadOre", 4, 0, 65536);
        minHeightGravelLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightGravelLeadOre", 0, 0, 256);
        ...
        biomeBlacklistGravelLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistGravelLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeSandstoneLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeSandstoneLeadOre", 4, 0, 65536);
        veinsPerChunkSandstoneLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkSandstoneLeadOre", 4, 0, 65536);
        minHeightSandstoneLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightSandstoneLeadOre", 0, 0, 256);
        ...
        biomeBlacklistSandstoneLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistSandstoneLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeRedSandstoneLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeRedSandstoneLeadOre", 4, 0, 65536);
        veinsPerChunkRedSandstoneLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkRedSandstoneLeadOre", 4, 0, 65536);
        minHeightRedSandstoneLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightRedSandstoneLeadOre", 0, 0, 256);
        ...
        biomeBlacklistRedSandstoneLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistRedSandstoneLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Blue Ice Lead Ore").push("blue_ice_lead_ore");
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enableBlueIceLeadOre = BUILDER.comment("If false, this ore variant will not generate.").define("enableBlueIceLeadOre", true);
        veinSizeBlueIceLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeBlueIceLeadOre", 4, 0, 65536);
        veinsPerChunkBlueIceLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkBlueIceLeadOre", 4, 0, 65536);
        minHeightBlueIceLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightBlueIceLeadOre", 0, 0, 256);
        maxHeightBlueIceLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightBlueIceLeadOre", 128, 0, 256);
        isTempWhitelistBlueIceLeadOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistBlueIceLeadOre", false);
        temperatureBlacklistBlueIceLeadOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistBlueIceLeadOre", new ArrayList<String>());
        isBiomeWhitelistBlueIceLeadOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistBlueIceLeadOre", false);
        biomeBlacklistBlueIceLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistBlueIceLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Packed Ice Lead Ore").push("packed_ice_lead_ore");
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enablePackedIceLeadOre = BUILDER.comment("If false, this ore variant will not generate.").define("enablePackedIceLeadOre", true);
        veinSizePackedIceLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizePackedIceLeadOre", 4, 0, 65536);
        veinsPerChunkPackedIceLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkPackedIceLeadOre", 4, 0, 65536);
        minHeightPackedIceLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightPackedIceLeadOre", 0, 0, 256);
        maxHeightPackedIceLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightPackedIceLeadOre", 128, 0, 256);
        isTempWhitelistPackedIceLeadOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistPackedIceLeadOre", false);
        temperatureBlacklistPackedIceLeadOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistPackedIceLeadOre", new ArrayList<String>());
        isBiomeWhitelistPackedIceLeadOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistPackedIceLeadOre", false);
        biomeBlacklistPackedIceLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistPackedIceLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        biomeBlacklistBedrockLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistBedrockLeadOre", new ArrayList<String>());
        BUILDER.pop();
        ...
        veinsPerChunkQuarkBasaltLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkBasaltLeadOre", 4, 0, 65536);
        ...
        veinSizeQuarkLimestoneLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkLimestoneLeadOre", 4, 0, 65536);
        veinsPerChunkQuarkLimestoneLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkLimestoneLeadOre", 4, 0, 65536);
        minHeightQuarkLimestoneLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkLimestoneLeadOre", 0, 0, 256);
        maxHeightQuarkLimestoneLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkLimestoneLeadOre", 40, 0, 256);
        ...
        veinSizeQuarkJasperLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkJasperLeadOre", 4, 0, 65536);
        veinsPerChunkQuarkJasperLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkJasperLeadOre", 4, 0, 65536);
        minHeightQuarkJasperLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkJasperLeadOre", 0, 0, 256);
        maxHeightQuarkJasperLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkJasperLeadOre", 40, 0, 256);
        ...
        veinSizeQuarkMarbleLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkMarbleLeadOre", 4, 0, 65536);
        veinsPerChunkQuarkMarbleLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkMarbleLeadOre", 4, 0, 65536);
        minHeightQuarkMarbleLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkMarbleLeadOre", 0, 0, 256);
        maxHeightQuarkMarbleLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkMarbleLeadOre", 40, 0, 256);
        ...
        veinSizeQuarkSlateLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkSlateLeadOre", 4, 0, 65536);
        veinsPerChunkQuarkSlateLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkSlateLeadOre", 4, 0, 65536);
        minHeightQuarkSlateLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkSlateLeadOre", 0, 0, 256);
        maxHeightQuarkSlateLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkSlateLeadOre", 40, 0, 256);
        ...
        veinSizeEmbellishcraftBasaltLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftBasaltLeadOre", 4, 0, 65536);
        veinsPerChunkEmbellishcraftBasaltLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftBasaltLeadOre", 4, 0, 65536);
        minHeightEmbellishcraftBasaltLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftBasaltLeadOre", 0, 0, 256);
        maxHeightEmbellishcraftBasaltLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftBasaltLeadOre", 40, 0, 256);
        ...
        veinSizeEmbellishcraftGneissLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftGneissLeadOre", 4, 0, 65536);
        veinsPerChunkEmbellishcraftGneissLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftGneissLeadOre", 4, 0, 65536);
        minHeightEmbellishcraftGneissLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftGneissLeadOre", 0, 0, 256);
        maxHeightEmbellishcraftGneissLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftGneissLeadOre", 40, 0, 256);
        ...
        veinSizeEmbellishcraftJadeLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftJadeLeadOre", 4, 0, 65536);
        veinsPerChunkEmbellishcraftJadeLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftJadeLeadOre", 4, 0, 65536);
        minHeightEmbellishcraftJadeLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftJadeLeadOre", 0, 0, 256);
        maxHeightEmbellishcraftJadeLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftJadeLeadOre", 40, 0, 256);
        ...
        veinSizeEmbellishcraftLarvikiteLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftLarvikiteLeadOre", 4, 0, 65536);
        veinsPerChunkEmbellishcraftLarvikiteLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftLarvikiteLeadOre", 4, 0, 65536);
        minHeightEmbellishcraftLarvikiteLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftLarvikiteLeadOre", 0, 0, 256);
        maxHeightEmbellishcraftLarvikiteLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftLarvikiteLeadOre", 40, 0, 256);
        ...
        veinSizeEmbellishcraftMarbleLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftMarbleLeadOre", 4, 0, 65536);
        veinsPerChunkEmbellishcraftMarbleLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftMarbleLeadOre", 4, 0, 65536);
        minHeightEmbellishcraftMarbleLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftMarbleLeadOre", 0, 0, 256);
        maxHeightEmbellishcraftMarbleLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftMarbleLeadOre", 40, 0, 256);
        ...
        veinSizeEmbellishcraftSlateLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftSlateLeadOre", 4, 0, 65536);
        veinsPerChunkEmbellishcraftSlateLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftSlateLeadOre", 4, 0, 65536);
        minHeightEmbellishcraftSlateLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftSlateLeadOre", 0, 0, 256);
        maxHeightEmbellishcraftSlateLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftSlateLeadOre", 40, 0, 256);
        ...
        veinSizeHardenedStoneLeadOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeHardenedStoneLeadOre", 4, 0, 65536);
        veinsPerChunkHardenedStoneLeadOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkHardenedStoneLeadOre", 4, 0, 65536);
        minHeightHardenedStoneLeadOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightHardenedStoneLeadOre", 0, 0, 256);
        maxHeightHardenedStoneLeadOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightHardenedStoneLeadOre", 40, 0, 256);
        ...
        biomeBlacklistHardenedStoneLeadOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:alps\"])").define("biomeBlacklistHardenedStoneLeadOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.pop();
        spec = BUILDER.build();
