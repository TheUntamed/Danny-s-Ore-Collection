...
public class Lapis {
    ...
    static {
        ...
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enableBlueIceLapisOre = BUILDER.comment("If false, this ore variant will not generate.").define("enableBlueIceLapisOre", true);
        veinSizeBlueIceLapisOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeBlueIceLapisOre", 7, 0, 65536);
        veinsPerChunkBlueIceLapisOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkBlueIceLapisOre", 1, 0, 65536);
        minHeightBlueIceLapisOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightBlueIceLapisOre", 0, 0, 256);
        maxHeightBlueIceLapisOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightBlueIceLapisOre", 128, 0, 256);
        isTempWhitelistBlueIceLapisOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistBlueIceLapisOre", false);
        temperatureBlacklistBlueIceLapisOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistBlueIceLapisOre", new ArrayList<String>());
        isBiomeWhitelistBlueIceLapisOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistBlueIceLapisOre", false);
        biomeBlacklistBlueIceLapisOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistBlueIceLapisOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Packed Ice Lapis Ore").push("packed_ice_lapis_ore");
        BUILDER.comment("Generation settings for this ore.").push("generation");
        enablePackedIceLapisOre = BUILDER.comment("If false, this ore variant will not generate.").define("enablePackedIceLapisOre", true);
        veinSizePackedIceLapisOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizePackedIceLapisOre", 7, 0, 65536);
        veinsPerChunkPackedIceLapisOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkPackedIceLapisOre", 1, 0, 65536);
        minHeightPackedIceLapisOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightPackedIceLapisOre", 0, 0, 256);
        maxHeightPackedIceLapisOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightPackedIceLapisOre", 128, 0, 256);
        isTempWhitelistPackedIceLapisOre = BUILDER.comment("If true, the biome temperature blacklist is a whitelist.").define("isTempWhitelistPackedIceLapisOre", false);
        temperatureBlacklistPackedIceLapisOre = BUILDER.comment("Possible Entries: \"MEDIUM\", \"WARM\", \"COLD\", \"OCEAN\"").define("temperatureBlacklistPackedIceLapisOre", new ArrayList<String>());
        isBiomeWhitelistPackedIceLapisOre = BUILDER.comment("If true, the biome blacklist is a whitelist.").define("isBiomeWhitelistPackedIceLapisOre", false);
        biomeBlacklistPackedIceLapisOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistPackedIceLapisOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
