...
public class Silver {
    ...
    static {
        ...
        veinSizeStoneSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeStoneSilverOre", 9, 0, 65536);
        veinsPerChunkStoneSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkStoneSilverOre", 20, 0, 65536);
        minHeightStoneSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightStoneSilverOre", 40, 0, 256);
        maxHeightStoneSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightStoneSilverOre", 128, 0, 256);
        ...
        biomeBlacklistStoneSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistStoneSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeAndesiteSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeAndesiteSilverOre", 9, 0, 65536);
        veinsPerChunkAndesiteSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkAndesiteSilverOre", 20, 0, 65536);
        minHeightAndesiteSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightAndesiteSilverOre", 40, 0, 256);
        maxHeightAndesiteSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightAndesiteSilverOre", 128, 0, 256);
        ...
        biomeBlacklistAndesiteSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistAndesiteSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeDioriteSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeDioriteSilverOre", 9, 0, 65536);
        veinsPerChunkDioriteSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkDioriteSilverOre", 20, 0, 65536);
        minHeightDioriteSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightDioriteSilverOre", 40, 0, 256);
        maxHeightDioriteSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightDioriteSilverOre", 128, 0, 256);
        ...
        biomeBlacklistDioriteSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistDioriteSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeGraniteSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeGraniteSilverOre", 9, 0, 65536);
        veinsPerChunkGraniteSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkGraniteSilverOre", 20, 0, 65536);
        minHeightGraniteSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightGraniteSilverOre", 40, 0, 256);
        maxHeightGraniteSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightGraniteSilverOre", 128, 0, 256);
        ...
        biomeBlacklistGraniteSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistGraniteSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinsPerChunkNetherrackSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkNetherrackSilverOre", 10, 0, 65536);
        ...
        biomeBlacklistNetherrackSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistNetherrackSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinsPerChunkEndStoneSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEndStoneSilverOre", 10, 0, 65536);
        ...
        biomeBlacklistEndStoneSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistEndStoneSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeSandSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeSandSilverOre", 9, 0, 65536);
        veinsPerChunkSandSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkSandSilverOre", 20, 0, 65536);
        minHeightSandSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightSandSilverOre", 40, 0, 256);
        ...
        biomeBlacklistSandSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistSandSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeRedSandSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeRedSandSilverOre", 9, 0, 65536);
        veinsPerChunkRedSandSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkRedSandSilverOre", 20, 0, 65536);
        minHeightRedSandSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightRedSandSilverOre", 40, 0, 256);
        ...
        biomeBlacklistRedSandSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistRedSandSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeGravelSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeGravelSilverOre", 9, 0, 65536);
        veinsPerChunkGravelSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkGravelSilverOre", 20, 0, 65536);
        minHeightGravelSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightGravelSilverOre", 40, 0, 256);
        ...
        biomeBlacklistGravelSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistGravelSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeSandstoneSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeSandstoneSilverOre", 9, 0, 65536);
        veinsPerChunkSandstoneSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkSandstoneSilverOre", 20, 0, 65536);
        minHeightSandstoneSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightSandstoneSilverOre", 40, 0, 256);
        ...
        biomeBlacklistSandstoneSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistSandstoneSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeRedSandstoneSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeRedSandstoneSilverOre", 9, 0, 65536);
        veinsPerChunkRedSandstoneSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkRedSandstoneSilverOre", 20, 0, 65536);
        minHeightRedSandstoneSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightRedSandstoneSilverOre", 40, 0, 256);
        ...
        biomeBlacklistRedSandstoneSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistRedSandstoneSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Bedrock Silver Ore").push("stone_silver_ore");
        BUILDER.comment("Generation settings for this ore.").push("generation");
        ...
        biomeBlacklistBedrockSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistBedrockSilverOre", new ArrayList<String>());
        BUILDER.pop();
        ...
        veinsPerChunkQuarkBasaltSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkBasaltSilverOre", 10, 0, 65536);
        ...
        veinSizeQuarkLimestoneSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkLimestoneSilverOre", 9, 0, 65536);
        veinsPerChunkQuarkLimestoneSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkLimestoneSilverOre", 20, 0,65536);
        minHeightQuarkLimestoneSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkLimestoneSilverOre", 40, 0,256);
        maxHeightQuarkLimestoneSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkLimestoneSilverOre", 128, 0, 256);
        ...
        veinSizeQuarkJasperSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkJasperSilverOre", 9, 0, 65536);
        veinsPerChunkQuarkJasperSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkJasperSilverOre", 20, 0,65536);
        minHeightQuarkJasperSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkJasperSilverOre", 40, 0,256);
        maxHeightQuarkJasperSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkJasperSilverOre", 128, 0, 256);
        ...
        veinSizeQuarkMarbleSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkMarbleSilverOre", 9, 0, 65536);
        veinsPerChunkQuarkMarbleSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkMarbleSilverOre", 20, 0,65536);
        minHeightQuarkMarbleSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkMarbleSilverOre", 40, 0,256);
        maxHeightQuarkMarbleSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkMarbleSilverOre", 128, 0, 256);
        ...
        veinSizeQuarkSlateSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkSlateSilverOre", 9, 0, 65536);
        veinsPerChunkQuarkSlateSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkSlateSilverOre", 20, 0,65536);
        minHeightQuarkSlateSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkSlateSilverOre", 40, 0,256);
        maxHeightQuarkSlateSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkSlateSilverOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftBasaltSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftBasaltSilverOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftBasaltSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftBasaltSilverOre", 20, 0,65536);
        minHeightEmbellishcraftBasaltSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftBasaltSilverOre", 40, 0,256);
        maxHeightEmbellishcraftBasaltSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftBasaltSilverOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftGneissSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftGneissSilverOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftGneissSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftGneissSilverOre", 20, 0,65536);
        minHeightEmbellishcraftGneissSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftGneissSilverOre", 40, 0,256);
        maxHeightEmbellishcraftGneissSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftGneissSilverOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftJadeSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftJadeSilverOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftJadeSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftJadeSilverOre", 20, 0,65536);
        minHeightEmbellishcraftJadeSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftJadeSilverOre", 40, 0,256);
        maxHeightEmbellishcraftJadeSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftJadeSilverOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftLarvikiteSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftLarvikiteSilverOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftLarvikiteSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftLarvikiteSilverOre", 20, 0,65536);
        minHeightEmbellishcraftLarvikiteSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftLarvikiteSilverOre", 40, 0,256);
        maxHeightEmbellishcraftLarvikiteSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftLarvikiteSilverOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftMarbleSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftMarbleSilverOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftMarbleSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftMarbleSilverOre", 20, 0,65536);
        minHeightEmbellishcraftMarbleSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftMarbleSilverOre", 40, 0,256);
        maxHeightEmbellishcraftMarbleSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftMarbleSilverOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftSlateSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftSlateSilverOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftSlateSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftSlateSilverOre", 20, 0, 65536);
        minHeightEmbellishcraftSlateSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftSlateSilverOre", 40, 0, 256);
        maxHeightEmbellishcraftSlateSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftSlateSilverOre", 128, 0, 256);
        ...
        veinSizeHardenedStoneSilverOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeHardenedStoneSilverOre", 9, 0, 65536);
        veinsPerChunkHardenedStoneSilverOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkHardenedStoneSilverOre", 20, 0, 65536);
        minHeightHardenedStoneSilverOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightHardenedStoneSilverOre", 40, 0, 256);
        maxHeightHardenedStoneSilverOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightHardenedStoneSilverOre", 128, 0, 256);
        ...
        biomeBlacklistHardenedStoneSilverOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistHardenedStoneSilverOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.pop();
        spec = BUILDER.build();
