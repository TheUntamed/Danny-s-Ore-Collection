...
public class Aluminum {
    ...
    static {
        ...
        veinSizeStoneAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeStoneAluminumOre", 9, 0, 65536);
        veinsPerChunkStoneAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkStoneAluminumOre", 20, 0, 65536);
        minHeightStoneAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightStoneAluminumOre", 40, 0, 256);
        maxHeightStoneAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightStoneAluminumOre", 128, 0, 256);
        ...
        biomeBlacklistStoneAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistStoneAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeAndesiteAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeAndesiteAluminumOre", 9, 0, 65536);
        veinsPerChunkAndesiteAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkAndesiteAluminumOre", 20, 0, 65536);
        minHeightAndesiteAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightAndesiteAluminumOre", 40, 0, 256);
        maxHeightAndesiteAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightAndesiteAluminumOre", 128, 0, 256);
        ...
        biomeBlacklistAndesiteAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistAndesiteAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeDioriteAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeDioriteAluminumOre", 9, 0, 65536);
        veinsPerChunkDioriteAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkDioriteAluminumOre", 20, 0, 65536);
        minHeightDioriteAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightDioriteAluminumOre", 40, 0, 256);
        maxHeightDioriteAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightDioriteAluminumOre", 128, 0, 256);
        ...
        biomeBlacklistDioriteAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistDioriteAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeGraniteAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeGraniteAluminumOre", 9, 0, 65536);
        veinsPerChunkGraniteAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkGraniteAluminumOre", 20, 0, 65536);
        minHeightGraniteAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightGraniteAluminumOre", 40, 0, 256);
        maxHeightGraniteAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightGraniteAluminumOre", 128, 0, 256);
        ...
        biomeBlacklistGraniteAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistGraniteAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinsPerChunkNetherrackAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkNetherrackAluminumOre", 10, 0, 65536);
        ...
        biomeBlacklistNetherrackAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistNetherrackAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinsPerChunkEndStoneAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEndStoneAluminumOre", 10, 0, 65536);
        ...
        biomeBlacklistEndStoneAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistEndStoneAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeSandAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeSandAluminumOre", 9, 0, 65536);
        veinsPerChunkSandAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkSandAluminumOre", 20, 0, 65536);
        minHeightSandAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightSandAluminumOre", 40, 0, 256);
        ...
        biomeBlacklistSandAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistSandAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeRedSandAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeRedSandAluminumOre", 9, 0, 65536);
        veinsPerChunkRedSandAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkRedSandAluminumOre", 20, 0, 65536);
        minHeightRedSandAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightRedSandAluminumOre", 40, 0, 256);
        ...
        biomeBlacklistRedSandAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistRedSandAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeGravelAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeGravelAluminumOre", 9, 0, 65536);
        veinsPerChunkGravelAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkGravelAluminumOre", 20, 0, 65536);
        minHeightGravelAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightGravelAluminumOre", 40, 0, 256);
        ...
        biomeBlacklistGravelAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistGravelAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeSandstoneAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeSandstoneAluminumOre", 9, 0, 65536);
        veinsPerChunkSandstoneAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkSandstoneAluminumOre", 20, 0, 65536);
        minHeightSandstoneAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightSandstoneAluminumOre", 40, 0, 256);
        ...
        biomeBlacklistSandstoneAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistSandstoneAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        ...
        veinSizeRedSandstoneAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeRedSandstoneAluminumOre", 9, 0, 65536);
        veinsPerChunkRedSandstoneAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkRedSandstoneAluminumOre", 20, 0, 65536);
        minHeightRedSandstoneAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightRedSandstoneAluminumOre", 40, 0, 256);
        ...
        biomeBlacklistRedSandstoneAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistRedSandstoneAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Bedrock Aluminum Ore").push("stone_aluminum_ore");
        BUILDER.comment("Generation settings for this ore.").push("generation");
        ...
        biomeBlacklistBedrockAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistBedrockAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        ...
        veinsPerChunkQuarkBasaltAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkBasaltAluminumOre", 10, 0, 65536);
        ...
        veinSizeQuarkLimestoneAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkLimestoneAluminumOre", 9, 0, 65536);
        veinsPerChunkQuarkLimestoneAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkLimestoneAluminumOre", 20, 0,65536);
        minHeightQuarkLimestoneAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkLimestoneAluminumOre", 40, 0,256);
        maxHeightQuarkLimestoneAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkLimestoneAluminumOre", 128, 0, 256);
        ...
        veinSizeQuarkJasperAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkJasperAluminumOre", 9, 0, 65536);
        veinsPerChunkQuarkJasperAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkJasperAluminumOre", 20, 0,65536);
        minHeightQuarkJasperAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkJasperAluminumOre", 40, 0,256);
        maxHeightQuarkJasperAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkJasperAluminumOre", 128, 0, 256);
        ...
        veinSizeQuarkMarbleAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkMarbleAluminumOre", 9, 0, 65536);
        veinsPerChunkQuarkMarbleAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkMarbleAluminumOre", 20, 0,65536);
        minHeightQuarkMarbleAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkMarbleAluminumOre", 40, 0,256);
        maxHeightQuarkMarbleAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkMarbleAluminumOre", 128, 0, 256);
        ...
        veinSizeQuarkSlateAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeQuarkSlateAluminumOre", 9, 0, 65536);
        veinsPerChunkQuarkSlateAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkQuarkSlateAluminumOre", 20, 0,65536);
        minHeightQuarkSlateAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightQuarkSlateAluminumOre", 40, 0,256);
        maxHeightQuarkSlateAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightQuarkSlateAluminumOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftBasaltAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftBasaltAluminumOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftBasaltAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftBasaltAluminumOre", 20, 0,65536);
        minHeightEmbellishcraftBasaltAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftBasaltAluminumOre", 40, 0,256);
        maxHeightEmbellishcraftBasaltAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftBasaltAluminumOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftGneissAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftGneissAluminumOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftGneissAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftGneissAluminumOre", 20, 0,65536);
        minHeightEmbellishcraftGneissAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftGneissAluminumOre", 40, 0,256);
        maxHeightEmbellishcraftGneissAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftGneissAluminumOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftJadeAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftJadeAluminumOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftJadeAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftJadeAluminumOre", 20, 0,65536);
        minHeightEmbellishcraftJadeAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftJadeAluminumOre", 40, 0,256);
        maxHeightEmbellishcraftJadeAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftJadeAluminumOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftLarvikiteAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftLarvikiteAluminumOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftLarvikiteAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftLarvikiteAluminumOre", 20, 0,65536);
        minHeightEmbellishcraftLarvikiteAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftLarvikiteAluminumOre", 40, 0,256);
        maxHeightEmbellishcraftLarvikiteAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftLarvikiteAluminumOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftMarbleAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftMarbleAluminumOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftMarbleAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftMarbleAluminumOre", 20, 0,65536);
        minHeightEmbellishcraftMarbleAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftMarbleAluminumOre", 40, 0,256);
        maxHeightEmbellishcraftMarbleAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftMarbleAluminumOre", 128, 0, 256);
        ...
        veinSizeEmbellishcraftSlateAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeEmbellishcraftSlateAluminumOre", 9, 0, 65536);
        veinsPerChunkEmbellishcraftSlateAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkEmbellishcraftSlateAluminumOre", 20, 0, 65536);
        minHeightEmbellishcraftSlateAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightEmbellishcraftSlateAluminumOre", 40, 0, 256);
        maxHeightEmbellishcraftSlateAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightEmbellishcraftSlateAluminumOre", 128, 0, 256);
        ...
        veinSizeHardenedStoneAluminumOre = BUILDER.comment("The amount of ores in one vein.").defineInRange("veinSizeHardenedStoneAluminumOre", 9, 0, 65536);
        veinsPerChunkHardenedStoneAluminumOre = BUILDER.comment("How many veins per chunk.").defineInRange("veinsPerChunkHardenedStoneAluminumOre", 20, 0, 65536);
        minHeightHardenedStoneAluminumOre = BUILDER.comment("The min y-level the ore will generate.").defineInRange("minHeightHardenedStoneAluminumOre", 40, 0, 256);
        maxHeightHardenedStoneAluminumOre = BUILDER.comment("The max y-level the ore will generate.").defineInRange("maxHeightHardenedStoneAluminumOre", 128, 0, 256);
        ...
        biomeBlacklistHardenedStoneAluminumOre = BUILDER.comment("Syntax: \"modid:biome\". E.g.: [\"minecraft:plains\", \"biomesoplenty:meadow\"])").define("biomeBlacklistHardenedStoneAluminumOre", new ArrayList<String>());
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.pop();
        spec = BUILDER.build();
