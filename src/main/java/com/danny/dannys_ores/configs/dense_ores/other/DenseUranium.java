...
public class DenseUranium {
    ...
    static {
        ...
        disableDensePoisonEffectUraniumOres = BUILDER.comment("If true, dense uranium ores will not poison players while in their inventory/hand.").define("disablePoisonEffect", false);
        ...
        veinsPerChunkBedrockDenseUraniumOre = BUILDER.comment(CommentHandler.getVeinsPerChunkComment()).defineInRange(PathHandler.getVeinsPerChunkPath(), 4, 0, 65536);
