...
public class DenseYellorite {
    ...
    static {
        ...
        disableDensePoisonEffectYelloriteOres = BUILDER.comment("If true, dense yellorite ores will not poison players while in their inventory/hand.").define("disablePoisonEffect", false);
        ...
        veinsPerChunkBedrockDenseYelloriteOre = BUILDER.comment(CommentHandler.getVeinsPerChunkComment()).defineInRange(PathHandler.getVeinsPerChunkPath(), 4, 0, 65536);
        ...
        maxHeightBedrockDenseYelloriteOre = BUILDER.comment(CommentHandler.getMaxHeightComment()).defineInRange(PathHandler.getMaxHeightPath(), 128, 0, 256);
