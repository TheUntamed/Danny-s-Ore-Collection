...
public class DenseSteel {
    ...
    static {
        ...
        veinsPerChunkBedrockDenseSteelOre = BUILDER.comment(CommentHandler.getVeinsPerChunkComment()).defineInRange(PathHandler.getVeinsPerChunkPath(), 4, 0, 65536);
        ...
        maxHeightBedrockDenseSteelOre = BUILDER.comment(CommentHandler.getMaxHeightComment()).defineInRange(PathHandler.getMaxHeightPath(), 128, 0, 256);
        ...
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Lime Stone Dense Steel Ore (Quark)").push("quark_limestone_dense_steel_ore");
        BUILDER.comment(CommentHandler.getGenerationComment()).push(PathHandler.getGenerationPath());
