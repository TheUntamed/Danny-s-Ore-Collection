...
public class DenseChargedCertusQuartz {
    ...
    static {
        ...
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Red Sandstone Dense Charged Certus Quartz Ore").push("red__sandstone_dense_charged_certus_quartz_ore");
        BUILDER.comment(CommentHandler.getGenerationComment()).push(PathHandler.getGenerationPath());
        ...
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Lime Stone Dense ChargedCertusQuartz Ore (Quark)").push("quark_limestone_charged_certus_quartz_ore");
        BUILDER.comment(CommentHandler.getGenerationComment()).push(PathHandler.getGenerationPath());
