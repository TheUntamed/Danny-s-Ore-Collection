...
public class DenseAmethyst {
    ...
    static {
        ...
        veinsPerChunkBedrockDenseAmethystOre = BUILDER.comment(CommentHandler.getVeinsPerChunkComment()).defineInRange(PathHandler.getVeinsPerChunkPath(), 1, 0, 65536);
        ...
        BUILDER.pop();
        BUILDER.pop();
        BUILDER.comment("Lime Stone Dense Amethyst Ore (Quark)").push("quark_limestone_amethyst_ore");
        BUILDER.comment(CommentHandler.getGenerationComment()).push(PathHandler.getGenerationPath());
