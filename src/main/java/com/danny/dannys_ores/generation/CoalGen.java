            ...
            if (Coal.enableDioriteCoalOre.get()) {
                if ((Coal.isTempWhitelistDioriteCoalOre.get() && Coal.temperatureBlacklistDioriteCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistDioriteCoalOre.get() && !Coal.temperatureBlacklistDioriteCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistDioriteCoalOre.get() && Coal.biomeBlacklistDioriteCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistDioriteCoalOre.get() && !Coal.biomeBlacklistDioriteCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("diorite", null, new BlockMatcher(Blocks.DIORITE)), BlockInit.DIORITE_COAL_ORE.get().getDefaultState(), Coal.veinSizeDioriteCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkDioriteCoalOre.get(), Coal.minHeightDioriteCoalOre.get(), 0, Coal.maxHeightDioriteCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableGraniteCoalOre.get()) {
                if ((Coal.isTempWhitelistGraniteCoalOre.get() && Coal.temperatureBlacklistGraniteCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistGraniteCoalOre.get() && !Coal.temperatureBlacklistGraniteCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistGraniteCoalOre.get() && Coal.biomeBlacklistGraniteCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistGraniteCoalOre.get() && !Coal.biomeBlacklistGraniteCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("granite", null, new BlockMatcher(Blocks.GRANITE)), BlockInit.GRANITE_COAL_ORE.get().getDefaultState(), Coal.veinSizeGraniteCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkGraniteCoalOre.get(), Coal.minHeightGraniteCoalOre.get(), 0, Coal.maxHeightGraniteCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableSandCoalOre.get()) {
                if ((Coal.isTempWhitelistSandCoalOre.get() && Coal.temperatureBlacklistSandCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistSandCoalOre.get() && !Coal.temperatureBlacklistSandCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistSandCoalOre.get() && Coal.biomeBlacklistSandCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistSandCoalOre.get() && !Coal.biomeBlacklistSandCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("sand", null, new BlockMatcher(Blocks.SAND)), BlockInit.SAND_COAL_ORE.get().getDefaultState(), Coal.veinSizeSandCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkSandCoalOre.get(), Coal.minHeightSandCoalOre.get(), 0, Coal.maxHeightSandCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableGravelCoalOre.get()) {
                if ((Coal.isTempWhitelistGravelCoalOre.get() && Coal.temperatureBlacklistGravelCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistGravelCoalOre.get() && !Coal.temperatureBlacklistGravelCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistGravelCoalOre.get() && Coal.biomeBlacklistGravelCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistGravelCoalOre.get() && !Coal.biomeBlacklistGravelCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("gravel", null, new BlockMatcher(Blocks.GRAVEL)), BlockInit.GRAVEL_COAL_ORE.get().getDefaultState(), Coal.veinSizeGravelCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkGravelCoalOre.get(), Coal.minHeightGravelCoalOre.get(), 0, Coal.maxHeightGravelCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableSandstoneCoalOre.get()) {
                if ((Coal.isTempWhitelistSandstoneCoalOre.get() && Coal.temperatureBlacklistSandstoneCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistSandstoneCoalOre.get() && !Coal.temperatureBlacklistSandstoneCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistSandstoneCoalOre.get() && Coal.biomeBlacklistSandstoneCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistSandstoneCoalOre.get() && !Coal.biomeBlacklistSandstoneCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("sandstone", null, new BlockMatcher(Blocks.SANDSTONE)), BlockInit.SANDSTONE_COAL_ORE.get().getDefaultState(), Coal.veinSizeSandstoneCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkSandstoneCoalOre.get(), Coal.minHeightSandstoneCoalOre.get(), 0, Coal.maxHeightSandstoneCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableRedSandstoneCoalOre.get()) {
                if ((Coal.isTempWhitelistRedSandstoneCoalOre.get() && Coal.temperatureBlacklistRedSandstoneCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistRedSandstoneCoalOre.get() && !Coal.temperatureBlacklistRedSandstoneCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistRedSandstoneCoalOre.get() && Coal.biomeBlacklistRedSandstoneCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistRedSandstoneCoalOre.get() && !Coal.biomeBlacklistRedSandstoneCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("red_sandstone", null, new BlockMatcher(Blocks.RED_SANDSTONE)), BlockInit.RED_SANDSTONE_COAL_ORE.get().getDefaultState(), Coal.veinSizeRedSandstoneCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkRedSandstoneCoalOre.get(), Coal.minHeightRedSandstoneCoalOre.get(), 0, Coal.maxHeightRedSandstoneCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableBlueIceCoalOre.get()) {
                if ((Coal.isTempWhitelistBlueIceCoalOre.get() && Coal.temperatureBlacklistBlueIceCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistBlueIceCoalOre.get() && !Coal.temperatureBlacklistBlueIceCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistBlueIceCoalOre.get() && Coal.biomeBlacklistBlueIceCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistBlueIceCoalOre.get() && !Coal.biomeBlacklistBlueIceCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("blue_ice", null, new BlockMatcher(Blocks.BLUE_ICE)), BlockInit.BLUE_ICE_COAL_ORE.get().getDefaultState(), Coal.veinSizeBlueIceCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkBlueIceCoalOre.get(), Coal.minHeightBlueIceCoalOre.get(), 0, Coal.maxHeightBlueIceCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableBedrockCoalOre.get()) {
                if ((Coal.isTempWhitelistBedrockCoalOre.get() && Coal.temperatureBlacklistBedrockCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistBedrockCoalOre.get() && !Coal.temperatureBlacklistBedrockCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistBedrockCoalOre.get() && Coal.biomeBlacklistBedrockCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistBedrockCoalOre.get() && !Coal.biomeBlacklistBedrockCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("bedrock", null, new BlockMatcher(Blocks.BEDROCK)), BlockInit.BEDROCK_COAL_ORE.get().getDefaultState(), Coal.veinSizeBedrockCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkBedrockCoalOre.get(), Coal.minHeightBedrockCoalOre.get(), 0, Coal.maxHeightBedrockCoalOre.get()))));
                    } } } }
        // Quark
            ...
            if (Coal.enableQuarkBasaltCoalOre.get()) {
                if ((Coal.isTempWhitelistQuarkBasaltCoalOre.get() && Coal.temperatureBlacklistQuarkBasaltCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistQuarkBasaltCoalOre.get() && !Coal.temperatureBlacklistQuarkBasaltCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistQuarkBasaltCoalOre.get() && Coal.biomeBlacklistQuarkBasaltCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistQuarkBasaltCoalOre.get() && !Coal.biomeBlacklistQuarkBasaltCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("quark_basalt", null, new BlockMatcher(BlockInit.QUARK_BASALT != null ? BlockInit.QUARK_BASALT : Blocks.BARRIER)), BlockInit.QUARK_BASALT_COAL_ORE.get().getDefaultState(), Coal.veinSizeQuarkBasaltCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkQuarkBasaltCoalOre.get(), Coal.minHeightQuarkBasaltCoalOre.get(), 0, Coal.maxHeightQuarkBasaltCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableQuarkMarbleCoalOre.get()) {
                if ((Coal.isTempWhitelistQuarkMarbleCoalOre.get() && Coal.temperatureBlacklistQuarkMarbleCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistQuarkMarbleCoalOre.get() && !Coal.temperatureBlacklistQuarkMarbleCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistQuarkMarbleCoalOre.get() && Coal.biomeBlacklistQuarkMarbleCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistQuarkMarbleCoalOre.get() && !Coal.biomeBlacklistQuarkMarbleCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("quark_marble", null, new BlockMatcher(BlockInit.QUARK_MARBLE != null ? BlockInit.QUARK_MARBLE : Blocks.BARRIER)), BlockInit.QUARK_MARBLE_COAL_ORE.get().getDefaultState(), Coal.veinSizeQuarkMarbleCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkQuarkMarbleCoalOre.get(), Coal.minHeightQuarkMarbleCoalOre.get(), 0, Coal.maxHeightQuarkMarbleCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableQuarkSlateCoalOre.get()) {
                if ((Coal.isTempWhitelistQuarkSlateCoalOre.get() && Coal.temperatureBlacklistQuarkSlateCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistQuarkSlateCoalOre.get() && !Coal.temperatureBlacklistQuarkSlateCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistQuarkSlateCoalOre.get() && Coal.biomeBlacklistQuarkSlateCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistQuarkSlateCoalOre.get() && !Coal.biomeBlacklistQuarkSlateCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("quark_slate", null, new BlockMatcher(BlockInit.QUARK_SLATE != null ? BlockInit.QUARK_SLATE : Blocks.BARRIER)), BlockInit.QUARK_SLATE_COAL_ORE.get().getDefaultState(), Coal.veinSizeQuarkSlateCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkQuarkSlateCoalOre.get(), Coal.minHeightQuarkSlateCoalOre.get(), 0, Coal.maxHeightQuarkSlateCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableQuarkJasperCoalOre.get()) {
                if ((Coal.isTempWhitelistQuarkJasperCoalOre.get() && Coal.temperatureBlacklistQuarkJasperCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistQuarkJasperCoalOre.get() && !Coal.temperatureBlacklistQuarkJasperCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistQuarkJasperCoalOre.get() && Coal.biomeBlacklistQuarkJasperCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistQuarkJasperCoalOre.get() && !Coal.biomeBlacklistQuarkJasperCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("quark_jasper", null, new BlockMatcher(BlockInit.QUARK_JASPER != null ? BlockInit.QUARK_JASPER : Blocks.BARRIER)), BlockInit.QUARK_JASPER_COAL_ORE.get().getDefaultState(), Coal.veinSizeQuarkJasperCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkQuarkJasperCoalOre.get(), Coal.minHeightQuarkJasperCoalOre.get(), 0, Coal.maxHeightQuarkJasperCoalOre.get()))));
                    } } } }
        // Embellishcraft
            ...
            if (Coal.enableEmbellishcraftBasaltCoalOre.get()) {
                if ((Coal.isTempWhitelistEmbellishcraftBasaltCoalOre.get() && Coal.temperatureBlacklistEmbellishcraftBasaltCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistEmbellishcraftBasaltCoalOre.get() && !Coal.temperatureBlacklistEmbellishcraftBasaltCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistEmbellishcraftBasaltCoalOre.get() && Coal.biomeBlacklistEmbellishcraftBasaltCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistEmbellishcraftBasaltCoalOre.get() && !Coal.biomeBlacklistEmbellishcraftBasaltCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("embellishcraft_basalt", null, new BlockMatcher(BlockInit.EMBELLISHCRAFT_BASALT != null ? BlockInit.EMBELLISHCRAFT_BASALT : Blocks.BARRIER)), BlockInit.EMBELLISHCRAFT_BASALT_COAL_ORE.get().getDefaultState(), Coal.veinSizeEmbellishcraftBasaltCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkEmbellishcraftBasaltCoalOre.get(), Coal.minHeightEmbellishcraftBasaltCoalOre.get(), 0, Coal.maxHeightEmbellishcraftBasaltCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableEmbellishcraftGneissCoalOre.get()) {
                if ((Coal.isTempWhitelistEmbellishcraftGneissCoalOre.get() && Coal.temperatureBlacklistEmbellishcraftGneissCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistEmbellishcraftGneissCoalOre.get() && !Coal.temperatureBlacklistEmbellishcraftGneissCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistEmbellishcraftGneissCoalOre.get() && Coal.biomeBlacklistEmbellishcraftGneissCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistEmbellishcraftGneissCoalOre.get() && !Coal.biomeBlacklistEmbellishcraftGneissCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("embellishcraft_gneiss", null, new BlockMatcher(BlockInit.EMBELLISHCRAFT_GNEISS != null ? BlockInit.EMBELLISHCRAFT_GNEISS : Blocks.BARRIER)), BlockInit.EMBELLISHCRAFT_GNEISS_COAL_ORE.get().getDefaultState(), Coal.veinSizeEmbellishcraftGneissCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkEmbellishcraftGneissCoalOre.get(), Coal.minHeightEmbellishcraftGneissCoalOre.get(), 0, Coal.maxHeightEmbellishcraftGneissCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableEmbellishcraftJadeCoalOre.get()) {
                if ((Coal.isTempWhitelistEmbellishcraftJadeCoalOre.get() && Coal.temperatureBlacklistEmbellishcraftJadeCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistEmbellishcraftJadeCoalOre.get() && !Coal.temperatureBlacklistEmbellishcraftJadeCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistEmbellishcraftJadeCoalOre.get() && Coal.biomeBlacklistEmbellishcraftJadeCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistEmbellishcraftJadeCoalOre.get() && !Coal.biomeBlacklistEmbellishcraftJadeCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("embellishcraft_jade", null, new BlockMatcher(BlockInit.EMBELLISHCRAFT_JADE != null ? BlockInit.EMBELLISHCRAFT_JADE : Blocks.BARRIER)), BlockInit.EMBELLISHCRAFT_JADE_COAL_ORE.get().getDefaultState(), Coal.veinSizeEmbellishcraftJadeCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkEmbellishcraftJadeCoalOre.get(), Coal.minHeightEmbellishcraftJadeCoalOre.get(), 0, Coal.maxHeightEmbellishcraftJadeCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableEmbellishcraftLarvikiteCoalOre.get()) {
                if ((Coal.isTempWhitelistEmbellishcraftLarvikiteCoalOre.get() && Coal.temperatureBlacklistEmbellishcraftLarvikiteCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistEmbellishcraftLarvikiteCoalOre.get() && !Coal.temperatureBlacklistEmbellishcraftLarvikiteCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistEmbellishcraftLarvikiteCoalOre.get() && Coal.biomeBlacklistEmbellishcraftLarvikiteCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistEmbellishcraftLarvikiteCoalOre.get() && !Coal.biomeBlacklistEmbellishcraftLarvikiteCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("embellishcraft_larvikite", null, new BlockMatcher(BlockInit.EMBELLISHCRAFT_LARVIKITE != null ? BlockInit.EMBELLISHCRAFT_LARVIKITE : Blocks.BARRIER)), BlockInit.EMBELLISHCRAFT_LARVIKITE_COAL_ORE.get().getDefaultState(), Coal.veinSizeEmbellishcraftLarvikiteCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkEmbellishcraftLarvikiteCoalOre.get(), Coal.minHeightEmbellishcraftLarvikiteCoalOre.get(), 0, Coal.maxHeightEmbellishcraftLarvikiteCoalOre.get()))));
                    } } } }
            ...
            if (Coal.enableHardenedStoneCoalOre.get()) {
                if ((Coal.isTempWhitelistHardenedStoneCoalOre.get() && Coal.temperatureBlacklistHardenedStoneCoalOre.get().contains(biomeTS)) || (!Coal.isTempWhitelistHardenedStoneCoalOre.get() && !Coal.temperatureBlacklistHardenedStoneCoalOre.get().contains(biomeTS))) {
                    if ((Coal.isBiomeWhitelistHardenedStoneCoalOre.get() && Coal.biomeBlacklistHardenedStoneCoalOre.get().contains(biomeRNS)) || (!Coal.isBiomeWhitelistHardenedStoneCoalOre.get() && !Coal.biomeBlacklistHardenedStoneCoalOre.get().contains(biomeRNS))) {
                        biome.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("hardened_stone", null, new BlockMatcher(BlockInit.HARDENED_STONE.get())), BlockInit.HARDENED_STONE_COAL_ORE.get().getDefaultState(), Coal.veinSizeHardenedStoneCoalOre.get())).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(Coal.veinsPerChunkHardenedStoneCoalOre.get(), Coal.minHeightHardenedStoneCoalOre.get(), 0, Coal.maxHeightHardenedStoneCoalOre.get()))));
                    } } } }
    }
}
