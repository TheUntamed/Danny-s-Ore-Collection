...
public class OreWithParticles extends BaseOre {
    ...
    public OreWithParticles(Block.Properties properties, VariantType blockBase, RichnessTypes rType, OreTypes oType, int minXp, int maxXp, BasicParticleType bpt) {
