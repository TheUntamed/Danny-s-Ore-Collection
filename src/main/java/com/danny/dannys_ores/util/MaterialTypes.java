...
public enum MaterialTypes {
    // Vanilla
    COAL("coal", OreTypes.COAL, MineralTypes.GEM, Material.ROCK, MaterialColor.BLACK, 1, ToolType.PICKAXE, SoundType.STONE, 5, 6, 0, new Forms[] {Forms.INGOT, Forms.STORAGE_BLOCK}),
    ...
    ARCANE("arcane", OreTypes.ARCANE_CRYSTAL, MineralTypes.CRYSTAL, Material.IRON, MaterialColor.ADOBE, 1, ToolType.PICKAXE, SoundType.METAL, 5, 6, 0, new Forms[] {}),
    ...
    private MaterialTypes(String name, OreTypes oType, MineralTypes mType, Material blockMaterial, MaterialColor color, int harvestLevel, ToolType tool, SoundType sound, float hardness, float resistance, int lightValue, Forms[] formsToExclude) {
        this.name = name;
        this.oType = oType;
        this.mType = mType;
