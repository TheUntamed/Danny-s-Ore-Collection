...
public enum StoneVariants {
    ...
    QUARK_BASALT("basalt", VariantsModId.QUARK, Material.ROCK, MaterialColor.BLACK, ToolType.PICKAXE, SoundType.STONE, 3.0F, 3.0F, 0.6F, 0, 1),
    QUARK_LIMESTONE("limestone", VariantsModId.QUARK, Material.ROCK, MaterialColor.STONE, ToolType.PICKAXE, SoundType.STONE, 3.0F, 3.0F, 0.6F, 0, 1),
    QUARK_JASPER("jasper", VariantsModId.QUARK, Material.ROCK, MaterialColor.DIRT, ToolType.PICKAXE, SoundType.STONE, 3.0F, 3.0F, 0.6F, 0, 1),
    QUARK_MARBLE("marble", VariantsModId.QUARK, Material.ROCK, MaterialColor.QUARTZ, ToolType.PICKAXE, SoundType.STONE, 3.0F, 3.0F, 0.6F, 0, 1),
    QUARK_SLATE("slate", VariantsModId.QUARK, Material.ROCK, MaterialColor.STONE, ToolType.PICKAXE, SoundType.STONE, 3.0F, 3.0F, 0.6F, 0, 1),
    EMBELLISHCRAFT_BASALT("basalt", VariantsModId.EMBELLISHCRAFT, Material.ROCK, MaterialColor.BLACK, ToolType.PICKAXE, SoundType.STONE, 3.0F, 3.0F, 0.6F, 0, 1),
    EMBELLISHCRAFT_GNEISS("gneiss", VariantsModId.EMBELLISHCRAFT, Material.ROCK, MaterialColor.SAND, ToolType.PICKAXE, SoundType.STONE, 3.0F, 3.0F, 0.6F, 0, 1),
    EMBELLISHCRAFT_JADE("jade", VariantsModId.EMBELLISHCRAFT, Material.ROCK, MaterialColor.LIME, ToolType.PICKAXE, SoundType.STONE, 3.0F, 3.0F, 0.6F, 0, 1),
    ...
    NETHERCRAFT_HEATSAND("heat_sand", VariantsModId.NETHERCRAFT, MyMaterials.SAND_ORE, MaterialColor.ADOBE, ToolType.PICKAXE, SoundType.STONE, 3.0F, 3.0F, 0.6F, 0, 1),
    ...
    private StoneVariants(String blockName, VariantsModId modid, Material material, MaterialColor color, ToolType tool, SoundType sound, float hardness, float resistance, float slipperiness, int increasedHarvestLevel, int xpMultiplier) {
